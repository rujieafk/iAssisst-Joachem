                ...
                <div id="content">
                    ...
                    <div className="container-fluid">
                        <div className="row justify-content-center">
                            <h4 className="m-0 font-weight-bold text-primary header-name">Certificate Request ( PHILHEALTH )</h4>
                        </div>
                    </div>
...
export default PHILHEALTHrequest;
